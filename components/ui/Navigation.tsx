 ...
 */
 ...
 import { Heart, Plus, Menu, X, Search, User, Home, ChefHat } from 'lucide-react';
       ...
       <div className="max-w-7xl mx-auto px-4">
         <div className="flex justify-between items-center h-16">
           ...
           <div className="hidden md:flex items-center space-x-6">
             ...
             <Link 
               href="/recipes/search" 
               className={`px-3 py-2 rounded-md flex items-center ${getLinkClasses('/recipes/search')}`}
               aria-current={isActiveLink('/recipes/search') ? 'page' : undefined}
             >
