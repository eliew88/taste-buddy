              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500"
                    placeholder="0.50"
                    disabled={true} // Disabled until payment processing is implemented
                  />
                </div>
                <p className="text-xs text-yellow-600 mt-2">
                  Payment processing will be available soon. For now, you can send appreciation messages!
                </p>
              </div>
            )}
